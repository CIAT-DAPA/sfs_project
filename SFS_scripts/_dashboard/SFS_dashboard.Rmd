---
title: "Sustainable Food Systems Dashboard"
output: 
...
```{r}
data <- read.csv("//dapadfs/Workspace_cluster_9/Sustainable_Food_System/SFS_indicators/sfs_index_normalized_indicators.csv")
```
